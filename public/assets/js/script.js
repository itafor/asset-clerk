...
function changeTheme($theme, $style, $themeStylesheet, $init) {
    ...
    if ($theme === 'lite') {
        $logo.attr('src', baseUrl+'/img/logo.png');
        ...
        $body.find('.dt-header .dt-brand__logo-img').attr('src', baseUrl + '/img/logo.png');
        $body.find('.dt-login__content-inner .dt-brand__logo-img').attr('src', baseUrl + '/img/logo.png');
