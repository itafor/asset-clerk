@extends('new.layouts.app', ['title' => 'Rental Report', 'page' => 'Report'])

@section('content')
    <!-- Page Header -->
        <div class="dt-page__header">
          <h1 class="dt-page__title"><i class="icon icon-card"></i> Rental Report</h1>
        </div>
        <!-- /page header -->
          ...
          <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
              ...
              <div class="dt-entry__heading">
                <h3 class="dt-entry__title">Rental Report</h3>
              </div>
              <!-- /entry heading -->
...
<!-- search description -->
<form action="{{route('report.get_rental_report')}}" method="post" autocomplete="false">
   @csrf
  <div class="row">
