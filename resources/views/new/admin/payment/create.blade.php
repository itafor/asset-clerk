                            ...
                            <div class="pl-lg-4">
                                <div class="row">
                                    ...
                                    <div class="form-group{{ $errors->has('property') ? ' has-danger' : '' }} col-6">
                                        ...
                                        <select name="property" id="property" class="form-control" required>
                                            ...
                                            @foreach ($properties as $p)
                                                <option value="{{$p->uuid}}" {{old('property') == $p->uuid ? 'selected' : ''}}>{{$p->description}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group{{ $errors->has('payment_type') ? ' has-danger' : '' }} col-6">
                                        ...
                                        <select name="payment_type" id="input-pt" class="form-control" required autofocus>
                                            ...
                                            @foreach (getPaymentTypes() as $type)
                                                <option value="{{$type->id}}" {{old('payment_type') == $type->id ? 'selected' : ''}}>{{$type->name}}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <select id="sc_type" name="service" class="form-control sc_type">
                                                    ...
                                                    <option value="fixed" {{old('service') == 'fixed' ? 'selected' : ''}}>Fixed</option>
                                                    <option value="variable" {{old('service') == 'fixed' ? 'selected' : ''}}>Variable</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div> --}}
                                    ...
                                    <div class="form-group{{ $errors->has('amount') ? ' has-danger' : '' }} col-6">
                                        ...
                                        <input type="integer" name="amount" id="input-amount" class="form-control form-control-alternative{{ $errors->has('amount') ? ' is-invalid' : '' }}" placeholder="Enter Amount" value="{{old('amount')}}" required>
