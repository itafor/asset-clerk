@extends('layouts.app', ['title' => 'Legal Report'])

@section('content')
@include('admin.rental.partials.header', ['title' => __('Legal Report')])
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                ...
                                <a href="{{route('report.legal')}}" class="btn btn-primary">Legal</a>
                                <hr>
                                <h3 class="mb-0">{{ __('Legal Report') }}</h3>
                            </div>
                        </div>
                    </div>
