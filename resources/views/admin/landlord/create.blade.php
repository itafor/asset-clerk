@extends('layouts.app', ['title' => __('Add Landlord')])

@section('content')
    @include('admin.landlord.partials.header', ['title' => __('Add Landlord')])   
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Landlord Management') }}</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('landlord.index') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('landlord.store') }}" autocomplete="off">
                            @csrf
