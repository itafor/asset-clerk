...
Dear {{$userDetail->firstname}} {{$userDetail->lastname}},<br/>
 ...
 <em> Below is a list of your rents that will be due within the next 90 days</em>
                                </p>
                            </td>
                        </tr>
                    </table>
         ...
         <h2>Due rentals in the next 90 days</h2>
