...
Dear {{$userDetail->firstname}} {{$userDetail->lastname}},<br/>
 ...
 <em> Below is a list of your rents that will be due within the next 30 days</em>
                                </p>
                            </td>
                        </tr>
                    </table>
         ...
         <h2>Due rentals in the next 30 days</h2>
          <h5>Total Unpaid Rents: <span style="color: red;">&#8358; {{number_format($totalRentsNotPaid,2)}}</span></h5>
                    <table class="table table-bordered" id="customers">
                        ...
                        <tbody>
                            @foreach ($rentalsDueInNext30Days2 as $rental)
                                <tr>
